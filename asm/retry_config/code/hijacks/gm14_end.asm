; Since UberASM Tool 2.0, there is now an end-of-frame routine for gamemodes and levels.
; If UberASM Tool 2.0 is detected, the end-of-frame hijack will be handled by UberASM instead.
