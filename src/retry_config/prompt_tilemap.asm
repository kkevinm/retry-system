...
; You usually shouldn't edit the cursor, but you can edit the line1 and line2 to
; change which tiles from the GFX file are used for the first and second line of the prompt.
; Of course, you also need to edit the GFX files if you want to add/remove letters.
...
; To find these out, take the two list of tiles !prompt_tiles_line1 and !prompt_tiles_line2 together and imagine them as a single list.
; This list corresponds to the available letters you can use (by default, R-E-T-Y-X-I).
